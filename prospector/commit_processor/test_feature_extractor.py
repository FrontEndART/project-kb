...
from .feature_extractor import (
    ...
    extract_commit_time_distance_after,
...
def test_extract_commit_time_distance_after():
    assert extract_commit_time_distance_after(1359961897, 1359961896) == 1
    assert extract_commit_time_distance_after(1359961896, 1359961896) is None
    assert extract_commit_time_distance_after(1359961895, 1359961896) is None
